...
// y mantenimientos.
const indicadores = [
  { titulo: 'Total de vehiculos', valor: '3', detalle: 'Registrados en la cuenta', icono: '🚗' },
  { titulo: 'Proximo mantenimiento', valor: '12 dias', detalle: 'Cambio de aceite - Aveo 2015', icono: '⏰' },
  { titulo: 'Alertas activas', valor: '2', detalle: 'Matricula y revision de frenos', icono: '⚠️' },
  { titulo: 'Gastos del mes', valor: '$ 145,00', detalle: 'Suma de servicios registrados', icono: '💵' },
];
